...
<!-- Module Megamenu-->
<div class="container_lab_vegamenu col-xs-12 col-sm-4 col-md-3">
<div class="lab-menu-vertical clearfix">
{$id_lang = Context::getContext()->language->id}
	
	<div class="title-menu"><span>{l s='Categories' d='Shop.Theme.Laberthemes'}</span><i class="icon-list"></i></div>
	...
	<ul class="menu-content">
		{foreach from=$menus item=menu name=menus}
			...
			{/if}
		{/foreach}
		<li class="all-cat"><span><i>+</i> {l s='More Collections' d='Shop.Theme.Laberthemes'}</span><span style="display:none"><i class="">-</i> {l s='Закрыть' d='Shop.Theme.Laberthemes'}</span></li>
	</ul>
	</div>
</div>
</div>
