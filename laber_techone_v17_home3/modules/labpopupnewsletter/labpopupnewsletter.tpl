	...
	<div id="newsletter_block_popup" class="block">
		...
		<form method="post">
				...
				<div class="labAlert"></div>				<div class="labernewsletter">
					<input class="inputNew" id="labnewsletter-input" type="text" name="email" placeholder="{l s='Enter your email address' d='Shop.Theme.Laberthemes'}"/>
					<div class="send-reqest button_unique">{l s='Subscribe' d='Shop.Theme.Laberthemes'}</div>				</div>
		</form>
		</div>
			<div class="newsletter_block_popup-bottom">
				...
				<label class="laber_newsletter_dont_show_again" for="laber_newsletter_dont_show_again">{l s='Do not show this popup again' d='Shop.Theme.Laberthemes'}</label>
			</div>
		</div>
	{/if}
</div>
