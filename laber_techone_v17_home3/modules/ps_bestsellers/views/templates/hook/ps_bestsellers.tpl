...
<section class="laberProductColumn laberColumn clearfix">
  <h3 class="title">{l s='Best Sellers' d='Shop.Theme.Laberthemes'}</h3>
  <div class="product_list">
	...
	<div class="owl-buttons">
		<p class="owl-prev prev-laberBestSellers"><i class="icon-chevron-left icon"></i></p>
		<p class="owl-next next-laberBestSellers"><i class="icon-chevron-right icon"></i></p>
	</div>
  {*<a href="{$allBestSellers}">{l s='All best sellers' d='Shop.Theme.Laberthemes'}</a>*}
</section>
