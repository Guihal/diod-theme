  	...
  	{foreach $product['customization'] as $customization}
  		<tr>
	  		<td colspan="3" style="padding: 10px 0;">
					<font size="2" face="Arial, sans-serif" color="#919191">
						<p style="margin: 0; padding: 0 5px; font-size: 14px">{$customization['customization_text']}</p>
					</font>
	  		</td>
				<td colspan="2" align="left" style="padding: 10px 0;">
					<font size="2" face="Arial, sans-serif" color="#919191">
						{if count($product['customization']) > 1}
							<p style="margin: 0; padding: 0; font-size: 14px;">{$customization['customization_quantity']}</p>
						{/if}
					</font>
				</td>
  		</tr>
